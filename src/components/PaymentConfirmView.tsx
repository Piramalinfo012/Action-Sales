    ...
    <div className="space-y-8 pb-12">
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-xl md:text-2xl font-black text-slate-900 dark:text-white">Payment Confirmation</h2>
            <p className="text-slate-500 dark:text-slate-400 text-xs font-medium">Confirm payments received.</p>
          </div>
        </div>
      </motion.div>
